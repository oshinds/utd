...
const Mission = (props) => (
  <div >
      ...
      <div className ='margin-200'>
        ...
        <div style={props.mobile? {display:'block'}:{display:'inline-flex'}}>
  ...
  render(){
    ...
    return(
          <div className='wrapper'>
            <Navbar collapseOnSelect fixedTop fluid componentClass={this.state.atTop && this.state.desktop? 'static' : 'fixed'}>
              <Navbar.Header>
                <Navbar.Brand>
            ...
            <WelcomeInfo/>
            <Mission mobile={this.state.mobile}/>
            <PicturePanel mobile={this.state.mobile} id={'WhatWeDo'} align='right' header='What We Do' caption={doCaptionPara()} picture='img-what-we-do.jpg' />
            <PicturePanel mobile={this.state.mobile} id={'HowWeDoIt'} align='left' header='How We Do It' caption={howCaptionPara()} picture='img-how-we-do-it.jpg' />
            <PicturePanel mobile={this.state.mobile} id={'WhoWeAre'} align='right' header='Who We Are' caption={whoCaptionPara()} picture='img-who-we-are.jpg' />
            <PicturePanel mobile={this.state.mobile} id={'Resources'} align='full' header='Resources' caption={resourcesCaptionPara()} picture='img-resources.jpg' />
            <PicturePanel mobile={this.state.mobile} id={'LatestNews'} align='left' header='Latest News' caption={newsCaptionPara()} picture='img-latest-news.jpg' />
            <PicturePanel mobile={this.state.mobile} id={'CommittedToYou'} align='right' header='Committed To You' caption={commitCaptionPara()} picture='img-commited.jpg' />
            <JoinUs />
            <Footer/>
          </div>
      );
