  ...
  render(){
    ...
    return(
          <div className='wrapper'>
            ...
            <WelcomeInfo/>
            <Mission/>
            <PicturePanel id={'WhatWeDo'} align='right' header='What We Do' caption={doCaptionPara()} picture='WhatWeDo.png' />
            <PicturePanel id={'HowWeDoIt'} align='left' header='How We Do It' caption={howCaptionPara()} picture='HowWeDoIt.png' />
            <PicturePanel id={'WhoWeAre'} align='right' header='Who We Are' caption={whoCaptionPara()} picture='WhoWeAre.png' />
            <PicturePanel id={'Resources'} align='full' header='Resources' caption={resourcesCaptionPara()} picture='Resources.png' />
            <PicturePanel id={'LatestNews'} align='left' header='Latest News' caption={newsCaptionPara()} picture='News.png' />
            <PicturePanel id={'CommittedToYou'} align='right' header='Committed To You' caption={commitCaptionPara()} picture='CommittedToYou.png' />
            {/* Join our team and footer here*/}
            <Footer/>
          </div>
      );
  }
